...
{   
    ...
    {
        return redirect()->route('admin.bons.client.edit', $id);
    }
...
<div class="space-y-6">
    ...
    <x-slot name="actions">
        <a href="{{ route('admin.bons.client.create') }}" class="px-5 py-2.5 bg-primary text-white rounded-xl font-bold text-sm shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:-translate-y-0.5 transition-all flex items-center">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($bons as $bon)
                        ...
                        <tr class="hover:bg-gray-50/30 transition-colors group" wire:key="bon-client-{{ $bon->id }}">
                            <td class="px-4 py-3">
