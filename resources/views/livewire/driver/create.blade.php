...
<!-- layout.blade.php -->
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 transition-all duration-500">
        <div class="space-y-1">
            ...
            <h1 class="text-4xl font-black text-gray-900 tracking-tight leading-none">Deliver <span class="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Better.</span></h1>
            <p class="text-gray-500 font-medium text-lg">Scan any package to view details and process delivery.</p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50/80 backdrop-blur-sm p-6 rounded-[2rem] border border-gray-100 space-y-4">
                <div class="flex items-center justify-between px-2">
                    <label class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Can't scan? Enter code</label>
                ...
                <div class="relative group">
                    <input 
                        ...
                        class="w-full pl-14 pr-6 py-5 bg-white border-transparent rounded-2xl focus:ring-8 focus:ring-primary/5 focus:border-primary shadow-sm hover:shadow-md transition-all text-base font-black tracking-tight placeholder-gray-300"
